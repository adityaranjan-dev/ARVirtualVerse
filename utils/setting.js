...
function getSettings() {
    var settings = storage.getItem("arvirtualverse-global-settings");
...
function getUserModels() {
    var models = storage.getItem("arvirtualverse-user-models");
    if (!models) models = [];
    return models;
}
...
function saveSettings(settings) {
    ...
    storage.setItem("arvirtualverse-global-settings", settings);
...
function addUserModels(model) {
    if (!model) return;
    models.push(model);
    storage.setItem("arvirtualverse-user-models", models);
}
